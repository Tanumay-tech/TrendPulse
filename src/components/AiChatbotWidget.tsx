...
export const AiChatbotWidget: React.FC<AiChatbotWidgetProps> = ({
  ...
  return (
    <>
      ...
      {!isOpen && (
        <div className="fixed bottom-20 lg:bottom-5 right-3 sm:right-5 z-40 flex items-center gap-2">
          {navigatedNotice && (
          ...
          <button
            ...
            className="group flex items-center gap-2 rounded-full border border-[#38bdf8]/40 bg-[#121824] px-3 sm:px-4 py-2 sm:py-2.5 text-xs font-semibold text-[#f1f5f9] shadow-[0_0_20px_rgba(56,189,248,0.2)] hover:border-[#38bdf8] hover:shadow-[0_0_25px_rgba(56,189,248,0.35)] transition-all duration-200"
      ...
      {isOpen && (
        <div
          ...
          className="fixed bottom-20 lg:bottom-5 right-3 sm:right-5 z-50 flex h-[480px] sm:h-[540px] w-96 max-w-[calc(100vw-24px)] flex-col rounded-2xl border border-slate-800 bg-[#121824]/95 text-[#f1f5f9] shadow-[0_0_35px_rgba(0,0,0,0.6)] backdrop-blur-xl animate-in fade-in slide-in-from-bottom-5 overflow-hidden"
        >
          {/* Header */}
